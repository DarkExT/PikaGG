...
package me.disaaltdev.pikagg.gui;

import me.disaaltdev.pikagg.PikaGG;

import me.disaaltdev.pikagg.gui.modern.ModernButton;
import me.disaaltdev.pikagg.gui.modern.ModernGui;
import me.disaaltdev.pikagg.gui.modern.ModernTextBox;
...
public class SettingsGui extends ModernGui {
    ...
    private static final PikaGG modInstance = PikaGG.getInstance();
    ...
    public void initGui() {
        ...
        this.buttonList.add(this.set = new ModernButton(1, this.width / 2 - 100, this.height / 2 + 2, 200, 20, "Set Delay").setEnabled(modInstance.isOn()));
        this.buttonList.add(this.reset = new ModernButton(2,this.width / 2 - 100, this.height / 2 + 26, 200, 20, "Reset Delay").setEnabled(modInstance.isOn()));
        this.buttonList.add(new ModernButton(3, this.width / 2 - 100, this.height / 2 + 70, 200, 20, "AutoGG: " + getStatus(modInstance.isOn())));
    }
    ...
    public void buttonPressed(ModernButton button) {
        switch (button.getId()) {
            ...
            case 1:
                if (!this.text.getText().isEmpty()) {
                    try {
                        ...
                        sendChatMessage("Only numbers are allowed!");
                    }
                } else {
                    sendChatMessage("No delay provided!");
                }
            ...
            case 3:
                ...
                this.changed = true;
                button.setText("PikaGG " + getStatus(modInstance.isOn()));
