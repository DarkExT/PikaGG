...
package me.disaaltdev.pikagg.gui.modern;
...
public abstract class ModernGui extends GuiScreen {
            ...
            for (int i = 0; i < this.buttonList.size(); ++i) {
                ...
                if (guibutton.mousePressed(this.mc, mouseX, mouseY)) {
                    ...
                    if (this.equals(this.mc.currentScreen))
                        MinecraftForge.EVENT_BUS.post(new net.minecraftforge.client.event.GuiScreenEvent.ActionPerformedEvent.Post(this, event.button, this.buttonList));
                }
            }
        }
    ...
    public final void sendChatMessage(String msg) {
        Minecraft.getMinecraft().thePlayer.addChatComponentMessage(new ChatComponentText(ChatColor.GOLD + "PikaGG" + ChatColor.AQUA + " » " + ChatColor.GRAY + ChatColor.translateAlternateColorCodes(msg)));
    }
